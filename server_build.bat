...
set name=server_chatworld
rem for %%I in (.) do set name=%%~nxI
...
set includes=%project%code\application\server_main.t %project%code %lang_path%\modules %lang_path%\modules\win32
